...
public class CadenceClientStatsReporterTest {
  ...
  private static final Map<String, String> DEFAULT_REPORT_TAGS = ImmutableMap
      .of("Domain", "domain_name", "TaskList", "task_list");
  ...
  public void testCounterShouldCallMetricRegistryForMonitoredCounterCadenceAction() {
    ...
    assertEquals(Arrays.asList(Tag.of("Domain", "domain_name"), Tag.of("TaskList", "task_list")),
  ...
  public void testTimerShouldCallMetricRegistryForMonitoredCounterCadenceAction() {
    ...
    assertEquals(10, Metrics.globalRegistry.get(DEFAULT_REPORT_NAME).timer().totalTime(TimeUnit.SECONDS), 0);
  }

  private void callDefaultCounter() {
    cadenceClientStatsReporter.reportCounter(DEFAULT_REPORT_NAME, DEFAULT_REPORT_TAGS, DEFAULT_COUNT);
  }

  private void callDefaultTimer() {
    cadenceClientStatsReporter.reportTimer(DEFAULT_REPORT_NAME, DEFAULT_REPORT_TAGS, DEFAULT_DURATION);
  }
